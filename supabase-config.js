...
(function(){
  var styles = [
    ...
    'missexplica-design-fixes.css?v=1','missexplica-desktop.css?v=1','missexplica-desktop-productivity.css?v=1','missexplica-desktop-workspace.css?v=1','missexplica-desktop-controls.css?v=1','missexplica-desktop-workspace-v2.css?v=1','missexplica-desktop-commandbar.css?v=1','missexplica-desktop-bugfixes.css?v=1'
  ];
