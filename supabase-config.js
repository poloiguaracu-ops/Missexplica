...
(function(){
  ...
  function shortcuts(){D.addEventListener('keydown',function(e){if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()==='k'){var i=D.getElementById('mx37Search')||D.getElementById('mxCourseSearch');if(i){e.preventDefault();i.focus();i.select()}}if(e.altKey&&e.key==='ArrowLeft'){var b=D.getElementById('backCourses');if(b){e.preventDefault();b.click()}}},false)}
...
(function(){
  var D=document;
  function load(){
    ['missexplica-functional-v37.js?v=1','missexplica-functional-v38.js?v=1'].forEach(function(src){var s=D.createElement('script');s.src=src;s.defer=true;D.head.appendChild(s)});
  }
