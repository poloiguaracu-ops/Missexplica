...
(function(){
  var D=document;
  function load(){
    ['missexplica-functional-v37.js?v=1','missexplica-functional-v38.js?v=1','missexplica-functional-v39.js?v=1'].forEach(function(src){var s=D.createElement('script');s.src=src;s.defer=true;D.head.appendChild(s)});
  }
